...
#define Trig BIT3
#define Echo BIT4 //might be the other way around idk
...
void main(void)
{
    ...
    P2DIR |= Trig; // enable the ultrasonic sensor
...
int getUltrasonicValue (void) {
    // Output the trigger signal for 10 microseconds
    P2DIR |= Trig;
    P2OUT |= Trig;
    __delay_cycles(10); // 10 microsecond pulse!
    P2OUT &= ~Trig;

    int numStepsWaited = 0;
    int length = 0;

//    while(numStepsWaited < 32768) {
//        __delay_cycles(10);
//        if ()
//    }
